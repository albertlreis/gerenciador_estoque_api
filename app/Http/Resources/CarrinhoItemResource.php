...
class CarrinhoItemResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'outlet_pagamento_id' => $this->outlet_pagamento_id,
            'outlet_preco_base' => $this->outlet_preco_base,
            'outlet_forma_pagamento_id' => $this->outlet_forma_pagamento_id,
            'outlet_forma_pagamento' => $this->outlet_forma_pagamento,
            'outlet_percentual_desconto' => $this->outlet_percentual_desconto,
            'outlet_max_parcelas' => $this->outlet_max_parcelas,
            'outlet_preco_final' => $this->outlet_preco_final,
