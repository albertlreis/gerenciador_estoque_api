...
class ExportContaPagarContaAzulJob implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    public function __construct(
        public readonly int $contaPagarId,
    ...
    public function handle(ExportacaoContaAzulService $export, ContaAzulConnectionService $connections): void
    {
        ...
        $conta = ContaPagar::query()->findOrFail($this->contaPagarId);
        $export->exportarContaPagar($conexao, $conta, $this->lojaId);
    }
}
