...
class AssistenciaChamadoItem extends Model
{
    ...
    {
        return $this->belongsTo(AssistenciaDefeito::class, 'defeito_id');
    }
    ...
    public function depositoAssistencia()
    {
        return $this->belongsTo(Deposito::class, 'deposito_assistencia_id');
    }
