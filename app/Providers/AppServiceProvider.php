...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(ConciliacaoContaAzulService::class, fn ($app) => new ConciliacaoContaAzulService(
            $app->make(ContaAzulAutoMatchService::class)
        ));
        ...
        $this->app->singleton(GoogleCalendarClient::class, fn ($app) => new GoogleCalendarClient(
            $app['config']->get('google_calendar', [])
        ));
        $this->app->singleton(GoogleCalendarOAuthService::class, fn ($app) => new GoogleCalendarOAuthService(
            $app['config']->get('google_calendar', [])
        ));
